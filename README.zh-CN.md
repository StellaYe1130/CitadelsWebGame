...
在线试玩：**https://citadelswebgame.onrender.com/**
...
- `getState()` 构建一次 `Map<Player, Role>` 反向映射，避免 O(n^2) 遍历
...
**单人模式：** 点击 *Solo vs AI*，选择玩家人数，然后开始游戏。

**多人模式：** 点击 *Multiplayer*，创建房间后分享 6 位房间码。其他玩家点击 *Join* 并输入房间码，所有真人玩家就位后游戏自动开始。
